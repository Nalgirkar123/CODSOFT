...
Player_Rock = PhotoImage(file="resources/rock.png")
Player_Rock_ado = Player_Rock.subsample(3, 3)
Player_Paper = PhotoImage(file="resources/paper.png")
Player_Paper_ado = Player_Paper.subsample(3, 3)
Player_Scissor = PhotoImage(file="resources/scissors.png")
Player_Scissor_ado = Player_Scissor.subsample(3, 3)
Computer_Rock = PhotoImage(file="resources/c_rock.png")
Computer_Paper = PhotoImage(file="resources/c_paper.png")
Computer_Scissor = PhotoImage(file="resources/c_scissors.png")
